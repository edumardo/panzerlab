"""Export the entire D.652-50c document as a single bilingual PDF.
...
bilingual/D.652-50c_bilingual_full_v1.0.pdf -- no per-section PDFs are kept.
...
def main():
    ...
    pdf.setTitle("D. 652/50c - complete bilingual facsimile + translation")
