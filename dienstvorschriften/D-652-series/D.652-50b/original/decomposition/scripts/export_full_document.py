"""Export the entire D.652-50b document as a single bilingual PDF.
...
page), then every section A01-A22 in manifest order (facsimile+translation
...
bilingual/D.652-50b_bilingual_full_v1.0.pdf -- no per-section PDFs are kept.
...
def main():
    ...
    pdf.setTitle("D. 652/50b - complete bilingual facsimile + translation")
