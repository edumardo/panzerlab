"""Title-page content for D.652-50a, rendered with the series-wide
...
TITLE_PAGE_SPEC = {
    "designation": "D 652/50a",
    "model_lines": [
        "Panzerkampfwagen III · Panzerbefehlswagen (Ausf. E–L)",
        "Gepanzerte Selbstfahrlafette / StuG (Ausf. A–G)",
    ],
    "subtitle_en": "Provisional repair instructions for the running gear",
    "subtitle_es": "Instrucciones provisionales de reparación del tren de rodaje",
    "subtitle_de": "Vorläufige Instandsetzungsanleitung für das Laufwerk",
    "edition_line": (
    ...
    "org_line": "Heereswaffenamt · Berlin, 1 March 1943",
    "credit_line": (
    ...
    "version_line": "Version 1.0 (draft — pending human review)",
}
